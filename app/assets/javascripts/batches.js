...
(function($) {
	jQuery.fn.stopwatch = function() {
		...
		clock.html('<div class="display"><span class="min">00</span>:<span class="sec">00</span></div>');
		clock.prepend('<input type="button" class="start" value="Start" />');
		clock.prepend('<input type="button" class="stop" value="Stop" />');
		clock.prepend('<input type="button" class="reset" value="Reset" />');
